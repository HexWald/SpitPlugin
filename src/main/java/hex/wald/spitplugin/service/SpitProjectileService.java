...
public class SpitProjectileService {
    ...
    private void spawnDustTrail(Location location, Vector velocity) {
        location.getWorld().spawnParticle(Particle.SMOKE_NORMAL, location, 2, 0.05, 0.05, 0.05, 0.006);
        location.getWorld().spawnParticle(Particle.ASH, location, 8, 0.08, 0.08, 0.08, 0.0);
        location.getWorld().spawnParticle(Particle.FALLING_DUST, location, 11, 0.1, 0.1, 0.1, 0.0, lightPowder);
        location.getWorld().spawnParticle(Particle.CAMPFIRE_COSY_SMOKE, location, 1, 0.02, 0.02, 0.02, 0.0);
        location.getWorld().spawnParticle(Particle.REDSTONE, location, 10, 0.07, 0.07, 0.07, 0.0, new Particle.DustOptions(Color.fromRGB(140, 140, 140), 1.35f));
        Location wake = location.clone().subtract(velocity.clone().normalize().multiply(0.12));
        location.getWorld().spawnParticle(Particle.FALLING_DUST, wake, 8, 0.06, 0.06, 0.06, 0.0, lightPowder);
        location.getWorld().spawnParticle(Particle.REDSTONE, wake, 5, 0.05, 0.05, 0.05, 0.0, new Particle.DustOptions(Color.fromRGB(115, 115, 115), 1.05f));
    }

    private void spawnSlimeTrail(Location location, Vector velocity) {
        location.getWorld().spawnParticle(Particle.ITEM_CRACK, location, 10, 0.09, 0.09, 0.09, 0.015, slimeItem);
        location.getWorld().spawnParticle(Particle.REDSTONE, location, 12, 0.08, 0.08, 0.08, 0.0, new Particle.DustOptions(Color.fromRGB(85, 205, 85), 1.25f));
        Location wake = location.clone().subtract(velocity.clone().normalize().multiply(0.12));
        location.getWorld().spawnParticle(Particle.ITEM_CRACK, wake, 6, 0.07, 0.07, 0.07, 0.01, slimeItem);
        location.getWorld().spawnParticle(Particle.REDSTONE, wake, 6, 0.06, 0.06, 0.06, 0.0, new Particle.DustOptions(Color.fromRGB(60, 180, 75), 1.0f));
    }

    private void spawnBurst(Location location, SpitType spitType) {
        if (spitType == SpitType.DUST) {
            location.getWorld().spawnParticle(Particle.SMOKE_NORMAL, location, 4, 0.14, 0.14, 0.14, 0.012);
            location.getWorld().spawnParticle(Particle.CAMPFIRE_COSY_SMOKE, location, 2, 0.1, 0.1, 0.1, 0.005);
            location.getWorld().spawnParticle(Particle.ASH, location, 20, 0.24, 0.24, 0.24, 0.01);
            location.getWorld().spawnParticle(Particle.FALLING_DUST, location, 30, 0.24, 0.24, 0.24, 0.0, lightPowder);
            location.getWorld().spawnParticle(Particle.REDSTONE, location, 22, 0.18, 0.18, 0.18, 0.0, new Particle.DustOptions(Color.fromRGB(150, 150, 150), 1.75f));
            return;
        }

        location.getWorld().spawnParticle(Particle.ITEM_CRACK, location, 22, 0.2, 0.2, 0.2, 0.025, slimeItem);
        location.getWorld().spawnParticle(Particle.REDSTONE, location, 20, 0.18, 0.18, 0.18, 0.0, new Particle.DustOptions(Color.fromRGB(70, 210, 85), 1.7f));
        location.getWorld().spawnParticle(Particle.REDSTONE, location, 10, 0.14, 0.14, 0.14, 0.0, new Particle.DustOptions(Color.fromRGB(35, 145, 55), 1.2f));
    }
}
